                                ...
                                <tbody>
                                    <?php foreach ($usersList as $u): ?>
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge badge-<?= getRoleBadge($u['role']) ?>"><?= getRoleLabel($u['role']) ?></span>
                                            </td>
                                            <?php if ($user['role'] === 'admin_geral'): ?>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    <button class="btn-icon" onclick='showEditUserModal(<?= json_encode($u) ?>)'
                                                        title="Editar">
                                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                                            <path
                                                    ...
                                                    <?php if ($u['role'] !== 'admin_geral'): ?>
                                                        <form method="POST" action="eliminar.php" style="display: inline;"
                                                            onsubmit="return confirm('Tem a certeza que deseja eliminar o utilizador \'<?= htmlspecialchars($u['nome']) ?>\'?');">
